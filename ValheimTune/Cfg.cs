...
namespace ValheimTune
{
    public static class Cfg
    {
        ...
        public static void Bind(ConfigFile c)
        {
            ...
            KnownGoodBuilds = c.Bind("Compat", "KnownGoodBuilds", Compat.DefaultKnownGoodBuilds, "Game versions (Version.CurrentVersion) this build of the plugin was verified against. Comma-separated.");
